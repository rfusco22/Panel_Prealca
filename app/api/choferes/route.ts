...
// Control de acceso por rol y por metodo: la lectura la necesitan hasta el dosificador (elige el chofer que
// trajo la materia prima) y gerencia; el alta y la baja son de admin, registro
// y seguridad-vial, que son los que tienen la ficha del chofer.
//
...
export async function GET() {
  const auth = await requireAuth(['admin', 'gerencia', 'registro', 'dosificador', 'seguridad-vial']);
