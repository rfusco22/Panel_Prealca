...
// Control de acceso por rol y por metodo: el catalogo de materiales lo mantiene solo admin: borrar un agregado
// deja huerfanas las entradas de materia prima que lo referencian.
//
