        ...
        <div className="bg-white rounded-xl border border-slate-200 p-5">
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-lg font-bold text-slate-900">{totalEntradas.toFixed(2)} M³</p>
            </div>
          </div>
        </div>
        <div className="bg-white rounded-xl border border-slate-200 p-5">
          <div className="flex items-center gap-3">
            ...
            <div>
              <p className="text-xs text-slate-500 font-medium">Total Consumido</p>
              <p className="text-lg font-bold text-slate-900">{totalConsumido.toFixed(2)} M³</p>
            </div>
          </div>
        </div>
        <div className="bg-white rounded-xl border border-slate-200 p-5">
          <div className="flex items-center gap-3">
            ...
            <div>
              <p className="text-xs text-slate-500 font-medium">Total Disponible</p>
              <p className="text-lg font-bold text-slate-900">{totalDisponible.toFixed(2)} M³</p>
            </div>
          </div>
        </div>
      </div>
      ...
      <div className="bg-white rounded-xl border border-slate-200 overflow-hidden">
        <div className="px-6 py-4 border-b border-slate-100">
          ...
          <p className="text-xs text-slate-500 mt-1">
            Cantidad máxima producible según materia prima disponible y fórmula
          </p>
        </div>
        <div className="overflow-x-auto">
          <table className="w-full">
            <thead>
              <tr className="bg-slate-50">
                ...
                <th className="text-right px-6 py-3 text-xs font-bold text-slate-500 uppercase">Stock Disponible</th>
