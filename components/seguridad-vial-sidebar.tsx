          ...
          >
            <div className="p-6 pt-8 flex items-center justify-between flex-shrink-0 relative">
              ...
              <div className="flex items-center gap-4 relative z-10">
                ...
                <div className="flex flex-col justify-center whitespace-nowrap">
                  <h2 className="font-black text-xl tracking-[0.1em] bg-gradient-to-br from-white via-amber-50 to-amber-300 bg-clip-text text-transparent">PREALCA</h2>
                  <p className="text-[9px] font-bold tracking-[0.3em] text-amber-400/80 uppercase mt-0.5">Panel de Control</p>
                </div>
              </div>
                ...
                return (
                  <Link key={item.id} href={item.href} onClick={onCloseMobile}>
                    <div className={`flex items-center gap-3 px-4 py-3 rounded-xl transition-all ${
                      ...
                      <Icon size={20} className={`${isActive ? accentColor : "text-slate-400"} shrink-0`} />
